        ...
        (function (ec) {
            ...
            var EcCrypto = (function (_super) {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        if (!baseKey.key) {
                            ...
                            if (!baseKey.extractable) {
                                throw new liner.LinerError("'baseKey' is Native CryptoKey. It can't be converted to JS CryptoKey");
                            }
                            else {
                                promise = promise.then(function () {
                                    return crypto.subtle.exportKey("jwk", baseKey);
                                })
                                    .then(function (jwk) {
                                    return _this.importKey("jwk", jwk, baseKey.algorithm, true, baseKey.usages);
                                });
                            }
                        }
                        promise.then(function (k) {
                            if (k)
                                baseKey = k;
                ...
                EcCrypto.deriveBits = function (algorithm, baseKey, length) {
                    ...
                    return new Promise(function (resolve, reject) {
                        var promise = Promise.resolve(null);
                        if (!algorithm.public.key)
                            promise = promise
                                .then(function () {
                                return crypto.subtle.exportKey("jwk", algorithm.public);
                            })
                                .then(function (jwk) {
                                return _this.importKey("jwk", jwk, baseKey.algorithm, true, baseKey.usages);
                            });
